...
public class main {
	...
	public static void main(String[] args) {
		Instructor insturctor1=new Instructor(1, "Engin Demiroğ", 35);
		Instructor insturctor2=new Instructor(2, "Engin Demiroğ", 35);
		
		Course course1=new Course(1,"Java+React Kursu","2 aylık kamp");
		Course course2=new Course(2,"C# Kursu","2 aylık kamp");
